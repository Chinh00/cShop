    ...
    where TDbContext : EventStoreDbContextBase
{
    ...
    public TDbContext CreateDbContext(string[] args)
    {
        ...
        var options = new DbContextOptionsBuilder<TDbContext>().UseSqlServer("Server=localhost;Database=EventStore;Encrypt=false;User Id=sa;Password=@P@ssw0rd02", builder =>
        {
